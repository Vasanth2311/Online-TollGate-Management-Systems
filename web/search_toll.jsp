...
<body>
  ...
  <div class="form">
      <form action="search_toll_result.jsp" method="post">
          <input type="text" placeholder="Enter The Keyword" name="search" required="" />

    <button type="submit">Search</button>
    <a href="user_toll_details.jsp"> <p>View All Toll Gates</p></a>
      </form>
  </div>
</div>
