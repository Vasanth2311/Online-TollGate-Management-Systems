...
<body>
  ...
  <%                         String search = request.getParameter("search");
                            ...
                            try {
                                ResultSet rs = st.executeQuery("Select * from toll_details where state LIKE '%" + search + "%' OR toll_name LIKE '%" + search + "%' OR section LIKE '%" + search + "%' ");
                                while (rs.next()) {
                        %>
                        <tr>
                        ...
                        <td><a href="feedback.jsp?id=<%=rs.getString("sno")%>" class="btn" style=" background-color: #009688; color: white" >Write Review</a></td>
                        <td><a href="book_ticket.jsp?id=<%=rs.getString("sno")%>" class="btn" style=" background-color: #009688; color: white" >Book Toll ticket</a></td>
                            </tr>
                    <%                                        }
                        } catch (Exception ex) {
                            ex.printStackTrace();
