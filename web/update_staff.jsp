...
<%
                        ...
                        %>
                                <div class="form">
                                    <form action="update_staff1.jsp" method="get" >
                                        <input type="text" placeholder="<%=rs.getString("sid")%>" value="<%=rs.getString("sid")%>"  name="sid" />
                                        <input type="text" placeholder="<%=rs.getString("name")%>" value="<%=rs.getString("name")%>" name="name" />
                                        <input type="text" placeholder="<%=rs.getString("email")%>" value="<%=rs.getString("email")%>" name="email" />
                                        <input type="text" placeholder="<%=rs.getString("phone")%>" value="<%=rs.getString("phone")%>" name="phone" />
                                        <textarea name="address" placeholder="<%=rs.getString("address")%>"><%=rs.getString("address")%></textarea>
                                        <input type="text" placeholder="<%=rs.getString("salary")%>" value="<%=rs.getString("salary")%>" name="salary" />
                                        <input type="text" placeholder="<%=rs.getString("branch")%>" value="<%=rs.getString("branch")%>" name="branch" />
                                        <select name="shift">
