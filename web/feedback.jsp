                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <table id="customers">
                                <%  String id = request.getParameter("id");
                                    ...
                                    try {
                                        ...
                                        if (rs.next()) {
                                            ...
                                            session.setAttribute("t_sec", t_sec );
                                %>
                                <tr>
                                <th>Branch No</th>
                                ...
                                <tr>
                                <th>Feedback</th>
                                <td><form action="feedback1.jsp" method="get"><textarea name="feedback" cols="40" rows="4"></textarea> &nbsp;&nbsp;&nbsp;<button class="btn" type="submit" style=" background-color: #009688; color: white">Submit</button></form></td>
                                <br>
